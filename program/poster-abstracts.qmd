...
for(i in 1:nrow(wed)) {
  ...
  cat(sprintf("## %s: %s", wed$poster.number[i], wed$Title.of.submission..max.250.characters..y[i]), "\n\n")
...
for(i in 1:nrow(thu)) {
  ...
  cat(sprintf("## %s: %s", thu$poster.number[i], thu$Title.of.submission..max.250.characters..y[i]), "\n\n")
