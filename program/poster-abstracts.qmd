...
pcomp <- subset(post, student.poster.competition == 1)
write.csv(pcomp[, c("authfullname", "Email.Address", "Title.of.submission..max.250.characters..y", "poster.number")], 
          "../data/poster-competition-entries.csv", row.names = FALSE)
```
